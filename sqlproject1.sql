...
FROM 'D:\Data Analyst\PROJECTS\SQL_PROJECT\Retail_store\sales.csv'
	WITH (
		FIRSTROW=2,
		FIELDTERMINATOR=',',
		ROWTERMINATOR='\n'
...
--so we can keep this products more in stock,as they are in demand
-----------------------------------------------------------------------------------------------------------
...
--we will make more staff avaILABLE
-----------------------------------------------------------------------------------------------------------
...
--gender-based ads,campaigns,personalized ads
